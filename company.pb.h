...
// required string company_name = 3;
inline bool Company::_internal_has_company_name() const {
...
template <typename ArgT0, typename... ArgT>
inline PROTOBUF_ALWAYS_INLINE
void Company::set_company_name(ArgT0&& arg0, ArgT... args) {
 _impl_._has_bits_[0] |= 0x00000002u;
...
inline void Company::set_allocated_company_name(std::string* company_name) {
...
// optional bool implementation_of_foreign_economic_activity = 5;
inline bool Company::_internal_has_implementation_of_foreign_economic_activity() const {
  bool value = (_impl_._has_bits_[0] & 0x00000010u) != 0;
  return value;
}
inline bool Company::has_implementation_of_foreign_economic_activity() const {
  return _internal_has_implementation_of_foreign_economic_activity();
}
inline void Company::clear_implementation_of_foreign_economic_activity() {
  _impl_.implementation_of_foreign_economic_activity_ = false;
  _impl_._has_bits_[0] &= ~0x00000010u;
}
inline bool Company::_internal_implementation_of_foreign_economic_activity() const {
  return _impl_.implementation_of_foreign_economic_activity_;
}
inline bool Company::implementation_of_foreign_economic_activity() const {
  // @@protoc_insertion_point(field_get:Company.implementation_of_foreign_economic_activity)
  return _internal_implementation_of_foreign_economic_activity();
}
inline void Company::_internal_set_implementation_of_foreign_economic_activity(bool value) {
  _impl_._has_bits_[0] |= 0x00000010u;
  _impl_.implementation_of_foreign_economic_activity_ = value;
}
inline void Company::set_implementation_of_foreign_economic_activity(bool value) {
  _internal_set_implementation_of_foreign_economic_activity(value);
  // @@protoc_insertion_point(field_set:Company.implementation_of_foreign_economic_activity)
}
