...
PROTOBUF_CONSTEXPR Company::Company(
  ...
  , /*decltype(_impl_.implementation_of_foreign_economic_activity_)*/false} {}
...
const uint32_t TableStruct_company_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  PROTOBUF_FIELD_OFFSET(::Company, _impl_.implementation_of_foreign_economic_activity_),
  3,
  0,
  1,
  2,
...
const char descriptor_table_protodef_company_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  "\n\rcompany.proto\"\233\001\n\007Company\022\032\n\022year_of_f"
  "oundation\030\001 \002(\005\022\025\n\rlegal_address\030\002 \002(\t\022\024"
  "\n\014company_name\030\003 \002(\t\022\022\n\noccupation\030\004 \001(\t"
  "\0223\n+implementation_of_foreign_economic_a"
...
const ::_pbi::DescriptorTable descriptor_table_company_2eproto = {
    false, false, 173, descriptor_table_protodef_company_2eproto,
    "company.proto",
...
Company::Company(const Company& from)
  ...
  new (&_impl_) Impl_{
    ...
    , decltype(_impl_.implementation_of_foreign_economic_activity_){}};
  ...
  ::memcpy(&_impl_.year_of_foundation_, &from._impl_.year_of_foundation_,
    static_cast<size_t>(reinterpret_cast<char*>(&_impl_.implementation_of_foreign_economic_activity_) -
    ...
    switch (tag >> 3) {
      ...
      case 3:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 26)) {
          ...
          CHK_(ptr);
          #ifndef NDEBUG
          ::_pbi::VerifyUTF8(str, "Company.company_name");
          #endif  // !NDEBUG
        } else
          goto handle_unusual;
        continue;
      ...
      case 5:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 40)) {
          ...
          _impl_.implementation_of_foreign_economic_activity_ = ::PROTOBUF_NAMESPACE_ID::internal::ReadVarint64(&ptr);
          CHK_(ptr);
        } else
          goto handle_unusual;
        continue;
...
uint8_t* Company::_InternalSerialize(
  ...
  if (cached_has_bits & 0x00000010u) {
    target = stream->EnsureSpace(target);
    target = ::_pbi::WireFormatLite::WriteBoolToArray(5, this->_internal_implementation_of_foreign_economic_activity(), target);
  }
...
void Company::InternalSwap(Company* other) {
  ...
  ::PROTOBUF_NAMESPACE_ID::internal::memswap<
      PROTOBUF_FIELD_OFFSET(Company, _impl_.implementation_of_foreign_economic_activity_)
      + sizeof(Company::_impl_.implementation_of_foreign_economic_activity_)
      - PROTOBUF_FIELD_OFFSET(Company, _impl_.year_of_foundation_)>(
